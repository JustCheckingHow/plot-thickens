...
def docx_to_markdown_chapters(file_path: str) -> List[str]:
    """
    ...
    if not headings:
        return [_convert_document_to_markdown(doc)]
...
def save_chapters_to_files(chapters: List[str], output_dir: str, base_filename: str = "chapter") -> List[str]:
    """
...
if __name__ == "__main__":
    chapters = docx_to_markdown_chapters("/Users/jm/repos/plot-thickens/data/Book with inconsistency.docx")
