...
const DocumentView = () => {
    ...
    return (
        <div>
            ...
            <Chapters chapters={chapters} handleAddnewChapter={handleAddnewChapter} changeChapter={setCurrentChapter} currentChapter={currentChapter}/>
